...
public:
	...
	FractionType Add(FractionType second){  // 분수의 덧셈
	...
	FractionType Sub(FractionType second){  // 분수의 뻴셈
	...
	FractionType Mult(FractionType second){  // 분수의 곱셈
	...
	FractionType Div(FractionType second, bool& possible){  // 분수의 나눗셈
...
int main(){
	...
	r1 = f1.Add(f2);  // 분수의 덧셈에 대한 결과값을 받음
	r2 = f1.Sub(f2);  // 분수의 뻴셈에 대한 결과값을 받음
	r3 = f1.Mult(f2);  // 분수의 곱셈에 대한 결과값을 받음
	r4 = f1.Div(f2, div_pos);  // 분수의 나눗셈에 대한 결과값을 받음
